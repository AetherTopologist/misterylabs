...
const PORTALS: ResearchPortal[] = [
  ...
  },
  {
    ...
    href: "https://xprimeray.github.io/GD_xPRIMEray/Research/cathedral_probe_architecture/",
    status: "research",
    icon: Telescope,
  },
  {
    ...
    href: "https://xprimeray.github.io/GD_xPRIMEray/Research/transport_island_microscopy/",
    status: "research",
    icon: Microscope,
  },
  {
    ...
    href: "https://xprimeray.github.io/GD_xPRIMEray/#current-milestone-curved-field-validation-ladder",
    status: "research",
    icon: Activity,
  },
];
...
const TECH_DOCS: ResearchPortal[] = [
  ...
  },
  {
    ...
    href: "https://xprimeray.github.io/GD_xPRIMEray/MisterYLabs/INSPIRATION_CARD_FEATURE_LINKS/",
    status: "research",
    icon: Sparkles,
  },
  {
    ...
    href: "https://xprimeray.github.io/GD_xPRIMEray/Release/FEATURE_READINESS_AUDIT/",
    status: "live",
    icon: Activity,
  },
  {
    ...
    href: "https://xprimeray.github.io/GD_xPRIMEray/Research/OPTICAL_TRANSPORT_FEATURE_MAP/",
    status: "research",
    icon: Compass,
  },
];
