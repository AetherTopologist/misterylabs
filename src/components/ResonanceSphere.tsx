...
export function ResonanceSphere({
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      // Edge rim / wormhole glow (cyan-amber)
      const rim = ctx.createRadialGradient(cx, cy, r * 0.92, cx, cy, r * 1.08);
      rim.addColorStop(0, "rgba(103, 232, 249, 0.0)");
      rim.addColorStop(0.85, "rgba(103, 232, 249, 0.35)");
      rim.addColorStop(1, "rgba(245, 158, 11, 0.25)");
      ctx.strokeStyle = rim;
      ctx.lineWidth = 6;
      ctx.beginPath();
      ctx.arc(cx, cy, r, 0, Math.PI * 2);
